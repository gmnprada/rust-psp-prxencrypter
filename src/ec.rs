...
// fn point_is_on_curve2(p: &[u8]) -> i32 {
...
//     hex_dump(Some("S"), &s, 20);
//     hex_dump(Some("T"), &t, 20);

//     elt_is_zero(&s)
// }

// fn dump_ecc() {
//     hex_dump(Some("P"), &EC_P, 20);
//     hex_dump(Some("a"), &EC_A, 20);
//     hex_dump(Some("b"), &EC_B, 20);
//     hex_dump(Some("N"), &EC_N, 21);
//     hex_dump(Some("Gx"), &EC_G.x, 20);
//     hex_dump(Some("Gy"), &EC_G.y, 20);
// }
